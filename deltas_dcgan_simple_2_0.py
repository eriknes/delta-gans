...
generator.add(Activation('relu'))
generator.add(UpSampling2D(size=(2, 2)))
generator.add(Conv2D(128, kernel_size=(16, 16), padding='same'))
generator.add(Activation('relu'))
generator.add(UpSampling2D(size=(2, 2)))
generator.add(Conv2D(1, kernel_size=(32, 32), padding='same', activation='sigmoid'))
generator.compile(loss='binary_crossentropy', optimizer=adam)

# Discriminator
discriminator = Sequential()
discriminator.add(Conv2D(64, kernel_size=(32, 32), strides=(2, 2), padding='same', input_shape=(1, nx, ny), kernel_initializer=initializers.RandomNormal(stddev=0.02)))
discriminator.add(LeakyReLU(0.2))
discriminator.add(Conv2D(128, kernel_size=(16, 16), strides=(2, 2), padding='same')
discriminator.add(LeakyReLU(0.2))
discriminator.add(Conv2D(256, kernel_size=(8, 8), strides=(2, 2), padding='same'))
discriminator.add(LeakyReLU(0.2))
